...
{	
	...
	{ 
		string a = "";
		entryproducto1.Text = a.ToString();
		entryproducto2.Text = a.ToString();
		entryproducto3.Text = a.ToString();
		entrysubtotal.Text = a.ToString();
		entryiva.Text = a.ToString();
		entrytotal.Text = a.ToString();
